...
while read -r line; do ${KAFKA_HOME}/bin/kafka-topics.sh --create --zookeeper Flob.local:2181 --replication-factor 1 --partitions 1 --topic $line"-TXT"; done <"${KAFKA_TOPICS_FILE}"
